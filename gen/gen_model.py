...
#    
  ...
  def neg_get_batch(self, train_data, bucket_id, batch_size, t=0):
      ...
      random.shuffle(batch_source_encoder)
      random.shuffle(batch_source_decoder)
      random.shuffle(encoder_inputs)
      random.shuffle(decoder_inputs)
